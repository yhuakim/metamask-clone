...
const Drawer = () => {
    ...
    return (
        <div className="min-h-screen text-base w-40 flex flex-col justify-between mx-auto fixed top-0 left-0 z-40 h-screen overflow-y-auto scrollbar-hide bg-[#1e1f25]">
            ...
            <div className="h-56 overflow-auto">
                <ul className="">
                    <li className="p-3 items-center hover:cursor-pointer hover:bg-[#25262b] border-r-4 border-[#415bbc]">
            ...
            <div className="">
                ...
                <button className="relative ml-3 rounded-3xl border border-gray-700 px-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 hidden">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 left-4">
